...
export function InstallPrompt() {
  ...
  const copyMap: Record<string, { title: string; description: string; action: string }> = {
    ru: { title: t('installTheApplication'), description: t('forQuickAccessAnd2'), action: t('install2') },
    ...
    uk: { title: t('installTheShutter'), description: t('forQuickAccessAnd'), action: t('install') },
  }
