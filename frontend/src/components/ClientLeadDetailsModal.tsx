  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm overflow-y-auto" onClick={(e) => { if (e.target === e.currentTarget) onClose() }}>
      <div className="w-full max-w-lg bg-white dark:bg-neutral-900 rounded-[2rem] p-6 shadow-2xl border border-white/10 relative">
        ...
        <div className="space-y-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="font-semibold text-neutral-900 dark:text-white">{lead.size || t('notSpecified2')}</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="font-semibold text-neutral-900 dark:text-white">{lead.style || t('notSpecified2')}</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="font-semibold text-neutral-900 dark:text-white">{lead.body_place || t('notSpecified3')}</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="font-semibold text-neutral-900 dark:text-white">
                {lead.cities?.name_ru || lead.city_name || t('notSpecified2')}
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="font-semibold text-neutral-900 dark:text-white">
                {lead.is_negotiable_budget ? t('byAgreement') : `${lead.client_budget} ${lead.client_currency || 'CZK'}`}
              </p>
            </div>
          </div>
        ...
        {images.length > 0 && (
          <div className="mt-6">
            <p className="text-xs text-neutral-500 font-bold uppercase mb-3">{t('references2')}{images.length})</p>
