                      ...
                      >
                        <label className="flex items-start gap-3 cursor-pointer group">
                          ...
                          <span className="text-xs font-medium text-neutral-500 leading-relaxed">
                            ...
                            {<>{t('iAgreeWith')} <a href="/terms" target="_blank" className="text-neutral-900 dark:text-white hover:underline">{t('termsOfService')}</a> {t('and')} <a href="/privacy" target="_blank" className="text-neutral-900 dark:text-white hover:underline">{t('privacyPolicy')}</a>.</>}
