-- Migration 029: Update unlock_lead RPC to support fiat balance deduction
...
BEGIN
    ...
    v_price_to_pay := p_deduct_amount;
    ...
    IF v_user.balance < v_price_to_pay THEN
        RAISE EXCEPTION 'INSUFFICIENT_CREDITS';
    END IF;

    -- Deduct balance
    UPDATE users 
    SET balance = balance - v_price_to_pay,
    ...
    RETURN json_build_object(
        'success', true, 
        'new_credits', v_user.balance - v_price_to_pay,
